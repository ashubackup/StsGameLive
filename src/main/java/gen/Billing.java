...
public class Billing extends HttpServlet
{
    ...
    public String getDateFormat(final String date) {
        ...
        final String data = String.valueOf(String.valueOf(String.valueOf(newarr[0]))) + " " + newarr[1];
        return data;
    }
    ...
    private synchronized void CreateFile(final StringBuffer Data) {
        ...
        try {
            final File hFile = new File(String.valueOf(String.valueOf(String.valueOf(this.CallbackPath))) + FileName + Rand + ".txt");
            ...
            final File hFilelck = new File(String.valueOf(String.valueOf(String.valueOf(this.CallbackPath))) + FileName + Rand + ".lck");
