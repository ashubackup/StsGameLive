                ...
                <div class="row py-md-5 min-vh-100 align-items-center justify-content-center">
                    <div class="col-md-7 col-lg-6 col-xl-6 py-3">
                        <div class="inner_content text-center px-3 py-4 p-md-5 bg-white rounded">
                            ...
                            %>
                            <h4 class="text-primary">You are already subscribed to the service.</h4>
                            <!-- <h6>Haven't received SMS?</h6> -->
                            <%
                              }
                            %>
                            <div class="submit-btn mt-4">
                                <button onclick="window.location.href='Login?type=offnet&msisdn=<%=ani %>&ref=<%=ref %>'" class="btn w-100 px-4 btn-block text-uppercase btn-primary submit-btn-cus">Try Again</button>
                            </div>
                        </div>
                    </div>
                </div>
